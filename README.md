...
```bash
"$INST_JAVA" -jar CreateVC-Updater.jar https://jammersmurph.github.io/CreateVC-Light/pack.toml
```
if that doesn't work, try
```bash
java -jar CreateVC-Updater.jar https://jammersmurph.github.io/CreateVC-Light/pack.toml
```
